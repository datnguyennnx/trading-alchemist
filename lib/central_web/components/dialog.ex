defmodule CentralWeb.Components.Dialog do
  @moduledoc """
    ...
    <div data-part="content" tabindex="0" hidden>
      ...
      >
        ...
        <button
          ...
          data-action="close"
          class="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]/dialog:bg-accent data-[state=open]/dialog:text-muted-foreground dark:ring-offset-background dark:focus:ring-ring"
        >
          <svg
  ...
  def dialog_title(assigns) do
    ~H"""
    <h3 class={
      classes(["text-lg font-semibold leading-none tracking-tight dark:text-foreground", @class])
    }>
      {render_slot(@inner_block)}
    </h3>
    """
